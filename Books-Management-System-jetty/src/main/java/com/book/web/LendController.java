...
public class LendController {
    ...
    public String bookLendDo(HttpServletRequest request, RedirectAttributes redirectAttributes, Integer readerId) {
        long bookId = Integer.parseInt(request.getParameter("id"));
        ReaderCard readerCard = readerCardService.getReaderCardById(readerId);
        if (readerCard == null) {
            redirectAttributes.addFlashAttribute("succ", "读者不存在！");
    ...
    public ModelAndView lendList() {
        ...
        modelAndView.addObject("list", lendService.allLendList());
        return modelAndView;
    }
