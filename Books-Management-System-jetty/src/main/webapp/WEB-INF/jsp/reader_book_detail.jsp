        ...
        <div class="panel-body">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <c:if test = "${detail.state == 1}">
                        <td><button type="button" class="btn btn-success btn-xs" id = "reseveBt" value="${detail.bookId}">预定书籍${detail.bookId}</button></td>
                    </c:if>
...
<script type="text/javascript">
    $("#reseveBt").click(function () {
        var bookId = $("#reseveBt").val();
        $.ajax({
            type: "POST",
            url: "/reader/addReserve",
            data: {
                bookId:bookId
            },
            dataType: "json",
